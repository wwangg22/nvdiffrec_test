...
if __name__ == "__main__":
    ...
    if FLAGS.base_mesh is None:
        ...
        # Run optimization
        geometry, mat = optimize_mesh(glctx, geometry, mat, lgt, dataset_train,
        ...
        # ==============================================================================================
        geometry, mat = optimize_mesh(glctx, geometry, base_mesh.material, lgt, dataset_train, FLAGS, 
        ...
        geometry, mat = optimize_mesh(glctx, geometry, mat, lgt, dataset_train, FLAGS, pass_idx=0, pass_name="mesh_pass", 
